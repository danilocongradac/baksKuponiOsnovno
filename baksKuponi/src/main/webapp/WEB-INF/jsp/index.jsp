		...
		<div class="container ">
			...
			<nav class="main-nav" id="main-nav">
	  		...
	  		<div class="jumbotron naslov" style="background-color: #e7f3f3; width: 100vw;"> 
				<h1 style="font-size: 13vw;" class="naslovText">Kuponi</h1>
			</div>	
			<div style="width: 100vw; margin: 0px; padding: 0px;">
				<h2 style="
				    ...
				    <br>
					Pa zdravo Baks...<br>
					jesi ti ona kreativna od nas dvoje, ali evo i ja znam da iznenadim.<br>
					Zeleo bih samo da ti kazem da si jedan od razloga zbog kojih cu pamtiti gis i ulepsala<br>
					si mi srednju. Hvala na svim loodim trenucima i uspomenama.<br>
					Zelim ti sve najjace, srecan rodjendan!!!<br>
					<br>
					PS Pamet u glavu kada budes koristila ove kupone!
