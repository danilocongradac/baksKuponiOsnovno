	...
	<div class="strana">
		<div class="container">
			...
			<nav class="main-nav" id="main-nav">
	  		...
	  		<div class="jumbotron naslov" style="background-color: #e7f3f3; width: 100vw;"> 
				<h1 style="font-size: 13vw;" class="naslovText">Uslovi</h1>
			</div>	
			<div style="width: 99vw; margin: 0px; padding: 0px;">
				<h2 style="
	    			text-align: center;
				    font-size: 350%;
				    left: ;
				    padding-left: 3vw;">
						...
						Ovako....<br>
						<br>
						Verovatno cu se pokajati zbog ovih kupona, ali ajde sta je tu je....<br>
						Uglavnom nema nekih prevelikih pravila/uslova, kada hoces da iskoristis kupon samo<br>
						klikni na njega, i iskoristi ga, nema potrebe da mi pises poruku, ili da me zoves da si ga<br> iskoristila, jer znas kako kazu... "sve znam, nista mi ne pricaj".<br>
						<br>
						Imas 4 kupona koje sama popunjavas, 1 kupon koji ti dozvoljava da ponovo iskoristis jedan od<br> prethodno iskorisćenih kupona, i 2 kupona koja mozes da iskoristis vise od jedanput(3 puta).<br> Poslednji kupon jednostavno nisam mogao da ogranicim sa brojem upotreba, tako da.... sto bi <br> mira rekla tezi +beskonacno <br>
						<br>
						Pametno koristi kupone, nemoj posle da zalim sto sam ih pravio :)<br>
						Unapred izvini na svim pravopisnim greskama, znas da mi to nije jaca strana!<br>
				</h2>
			</div>
		</div>
	</div>
